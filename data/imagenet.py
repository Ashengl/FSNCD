...
def merge_dataset(dataset1, dataset2):
    ...
    dataset1.data = np.concatenate((dataset1.samples, dataset2.samples), axis=0)
...
def get_imagenet_100_datasets(train_transform, test_transform, train_classes=range(80),
    ...
    train_dataset_1 = subsample_classes(deepcopy(whole_training_set), include_classes=args.train_classes)
    test_dataset_1 = subsample_classes(deepcopy(whole_training_set), include_classes=args.unlabeled_classes)

    train_dataset_2 = subsample_classes(deepcopy(test_dataset), include_classes=args.train_classes)
    test_dataset_2 = subsample_classes(deepcopy(test_dataset), include_classes=args.unlabeled_classes)
    ...
    train_dataset_labelled = train_dataset
