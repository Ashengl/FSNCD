...
car_root = r'/media/cs4007/adfc2692-0951-4a9b-8ea6-ebfa0e11323b/lcm/Data/scars/cars_{}/'
meta_default_path = r'/media/cs4007/adfc2692-0951-4a9b-8ea6-ebfa0e11323b/lcm/Data/scars/car_devkit/devkit/cars_{}.mat'
...
def merge_dataset(dataset1, dataset2):
    ...
    dataset1.target.extend(dataset2.target)
...
def get_scars_datasets(train_transform, test_transform, train_classes=range(160), prop_train_labels=0.8,
    ...
    training_set = subsample_classes(deepcopy(whole_training_set), include_classes=train_classes)
    test_set = CarsDataset(data_dir=car_root, transform=test_transform, metas=meta_default_path, train=False)
    ...
    train_dataset_labelled.label = train_dataset_labelled.target
    if split_train_val:
        val_dataset_labelled.label = val_dataset_labelled.target
    test_dataset.label = test_dataset.target
